...
export class SampleVpcEcsStack extends base.VpcBaseStack {
  ...
  onPostConstructor(baseVpc?: ec2.IVpc) {
    ...
    const databaseSecret = sm.Secret.fromSecretCompleteArn(
      this,
      "secret",
      databaseSecretArn
    )
    ...
    const albEcsService = new ecsPatterns.ApplicationLoadBalancedFargateService(
      this,
      "Service",
      {
    ...
    databaseSecurityGroup.addIngressRule(
      albEcsService.service.connections.securityGroups[0],
      ec2.Port.tcp(3306),
      "from backend sg"
    )
  }
